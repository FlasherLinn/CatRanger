...
var Ob = function (a, b) {
	...
	this.cLevel = b;
	this.cRescuedPets = 0;
	this.levels = [this.l1, this.l2, this.l3, this.l4, this.l5, this.l6, this.l7, this.l8]};
...
var rc = function () {
	this.root = (new D).add(new ka);
	this.levelSelectLayer = d.addFillSprite(this.root, 0, 0, 0, d.width, 1000, 1, !1);
	this.levelSelectLayer._compMap.Sprite_0.y.set__(-1920);
	this.levelSelectLayer.add(new Pb(!0));
	var a;
	a = d.addImageSprite(this.levelSelectLayer, 0, 1000, "game_scene_bg", 1, 1, !1)._compMap.Sprite_0;
	a.setRotation(180);
	a.setScaleXY(-1, 1);
	d.addImageSprite(this.levelSelectLayer, 0, 1000, "game_scene_bg", 1, 1, !1);
	d.addFillSprite(this.root, 640, 0, 0, 220, 1000, 1, !1);
	d.addFillSprite(this.root, -220, 0, 0, 220, 1000, 1, !1);

	this.initLevelSelectButton(250, 850, "1");
	this.initLevelSelectButton(450, 750, "2");
	this.initLevelSelectButton(250, 650, "3");
	this.initLevelSelectButton(450, 550, "4");
	this.initLevelSelectButton(250, 450, "5");
	this.initLevelSelectButton(450, 350, "6");
	this.initLevelSelectButton(250, 250, "7");
	this.initLevelSelectButton(450, 150, "8");
...
rc.prototype = {
	initLevelSelectButton: function (a, b, c) {
		var e =
			x.parseInt(c) - 1,
			a = d.addButton(this.levelSelectLayer, a, b, "btn_level_select"+c, function () {
				X.cLevel = e;
				gradle.event('levelStarted',e + 1);
				d.goToScene((new X).root);
			});
		e <= fa.unlockedLevels ? d.addLabel(a, 58, 50, "", 1, 1, !0, "score_font") : (a._compMap.Sprite_0.disablePointer(), d.addImageSprite(a, 61, 60, "lock_icon"))
	},
	__class__: rc
};
	...
	obj: {
		assets: [{
			main: [{
            	...
            	bytes: 23949,
            	md5: "a5693c68ad323e8ea1aa0c3eb7463758",
            	name: "btn_level_select1.png"
            },{
                bytes: 22305,
                md5: "2cc02cb5e1fc73e2774eb6d0c979be29",
                name: "btn_level_select2.png"
            }, {
                bytes: 25294,
                md5: "aca7284f73470f8f9de719134be4f748",
                name: "btn_level_select3.png"
            }, {
                bytes: 27761,
                md5: "6064380d8c6b166014de872775412927",
                 name: "btn_level_select4.png"
            }, {
                bytes: 23648,
                md5: "5b2e7cb84602d65295accd3b62a58805",
                name: "btn_level_select5.png"
            },{
                bytes: 21182,
                md5: "cb4b763c30becde0f870a60de55cf04d",
                name: "btn_level_select6.png"
            }, {
                bytes: 22094,
                md5: "024d5ca225f05e2f1b907b597cc24d32",
                name: "btn_level_select7.png"
            }, {
                bytes: 23346,
                md5: "cf93367c95b49f576c5b98db12a49c78",
                name: "btn_level_select8.png"
            },{
				bytes: 7982,
